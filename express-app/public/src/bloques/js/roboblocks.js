    ...
    var load = function(options) {
        ...
        (function() {
            var language = {
                ...
                LANG_SALIDAS_BLUETOOTH_RECEIVE: 'Bluetooth: rebre ',
                LANG_SALIDAS_BLUETOOTH_RECEIVE_BLUETOOTH: 'Bluetooth',
                LANG_SALIDAS_BLUETOOTH_RECEIVE_TOOLTIP: 'Retorna les dades rebudes pel mòdul Bluetooth',
                LANG_SALIDAS_BLUETOOTH_SEND: 'Bluetooth: Enviar',
                LANG_SALIDAS_BLUETOOTH_SEND_SEND: 'Enviar dades',
                LANG_SALIDAS_BLUETOOTH_SEND_TOOLTIP: 'Pren les dades de l\'entrada i les envia usant el mòdul Bluetooth',
                LANG_SALIDAS_BLUETOOTH_DEF: 'Bluetooth',
                LANG_SALIDAS_BLUETOOTH_DEF_BAUD_RATE: 'Taxa de bauds',
                LANG_SALIDAS_BLUETOOTH_DEF_PIN1: 'RX',
                LANG_SALIDAS_BLUETOOTH_DEF_PIN2: 'TX',
                LANG_SALIDAS_BLUETOOTH_DEF_NAME: 'Nom',
                LANG_SALIDAS_BLUETOOTH_DEF_PINCODE: 'Codi PIN',
                LANG_SALIDAS_BLUETOOTH_DEF_RECEIVE: 'Recibir',
                LANG_SALIDAS_BLUETOOTH_DEF_SEND: 'Rebre',
                LANG_SALIDAS_BLUETOOTH_DEF_TOOLTIP: 'Definició del mòdul Bluetooth',
                ...
                //SALIDAS blocks :
                LANG_CATEGORY_SALIDAS: 'Octopus bloqs',
                LANG_ENTRADAS_ULTRASONIDO: 'BAT - Sensor d\'Ultrasons',
                LANG_ENTRADAS_ULTRASONIDO_RED_PIN: 'ECHO PIN#',
                LANG_ENTRADAS_ULTRASONIDO_BLUE_PIN: 'TRIGGER PIN#',
                LANG_ENTRADAS_ULTRASONIDO_TOOLTIP: 'Retorna la distància mesurada pel sensor.',
                LANG_SALIDAS_BUTTON: 'Botó',
                LANG_SALIDAS_BUTTON_PIN: 'PIN#',
                LANG_SALIDAS_BUTTON_TOOLTIP: 'Botó',
             
                LANG_ENTRADAS_PIR: 'Sensor infraroig',
                LANG_ENTRADAS_PIR_PIN: 'PIN#',
                LANG_ENTRADAS_PIR_TOOLTIP: 'Retorna el valor digital mesurat pel sensor infraroig',
                LANG_SALIDAS_JOYSTICK: 'Joystick',
                LANG_SALIDAS_JOYSTICK_PIN_X: 'Eix X PIN#',
                LANG_SALIDAS_JOYSTICK_PIN_Y: 'Eix Y PIN#',
                LANG_SALIDAS_JOYSTICK_POSITION: 'Posició Joystick',
                LANG_SALIDAS_JOYSTICK_PIN_BUTTON: 'Polsador PIN#',
                LANG_SALIDAS_JOYSTICK_TOOLTIP: 'Joystick',
                LANG_SALIDAS_LED: 'LED',
                LANG_SALIDAS_LED_PIN: 'PIN#',
                LANG_SALIDAS_LED_STATE: '',
                LANG_SALIDAS_LED_ON: 'ENCENDRE',
                LANG_SALIDAS_LED_OFF: 'APAGAR',
                LANG_SALIDAS_LED_TOOLTIP: 'LED',
                LANG_SALIDAS_PHOTORESISTOR: 'Sensor de Llum',
                LANG_SALIDAS_PHOTORESISTOR_PIN: 'PIN#',
                LANG_SALIDAS_PHOTORESISTOR_TOOLTIP: 'Retorna el valor analògic mesurat per la fotorresistencia.',
                LANG_SALIDAS_PIEZO_BUZZER: 'Brunzidor',
                LANG_SALIDAS_PIEZO_BUZZER_PIN: 'PIN#',
                LANG_SALIDAS_PIEZO_BUZZER_TONE: 'TO',
                ...
                LANG_SALIDAS_PIEZO_BUZZER_DURATION: 'Durada',
                LANG_SALIDAS_PIEZO_BUZZER_TOOLTIP: 'Brunzidor Piezoelèctric',
                LANG_SALIDAS_PIEZO_BUZZERAV: 'Brunzidor avançat',
                LANG_SALIDAS_PIEZO_BUZZERAV_PIN: 'PIN#',
                LANG_SALIDAS_PIEZO_BUZZERAV_TONE: 'TON',
                LANG_SALIDAS_PIEZO_BUZZERAV_DURATION: 'Durada',
                LANG_SALIDAS_PIEZO_BUZZERAV_TOOLTIP: 'Brunzidor avançat',
                LANG_SALIDAS_POTENTIOMETER: 'Potenciòmetre',
                LANG_SALIDAS_POTENTIOMETER_PIN: 'PIN#',
                LANG_SALIDAS_POTENTIOMETER_TOOLTIP: 'Retorna el valor analògic mesurat pel potenciòmetre',
                //LCD blocks:
                ...
                //ENTRADAS blocks :
                LANG_CATEGORY_ENTRADAS: 'ENTRADAS bloqs',
                LANG_ENTRADAS_BUTTON: 'Botó',
                LANG_ENTRADAS_BUTTON_PIN: 'PIN#',
                LANG_ENTRADAS_BUTTON_TOOLTIP: 'Botó ENTRADAS',
                LANG_ENTRADAS_FOLLOWER: 'Sensor infraroig',
                LANG_ENTRADAS_FOLLOWER_PIN_LEFT: 'PIN IZQUIERDA#',
                LANG_ENTRADAS_FOLLOWER_PIN_RIGHT: 'PIN DERECHA#',
                LANG_ENTRADAS_FOLLOWER_LEFT: 'Esquerra',
                LANG_ENTRADAS_FOLLOWER_RIGHT: 'Dreta',
                LANG_ENTRADAS_FOLLOWER_TOOLTIP: 'Retorna el valor digital del sensor infraroig ENTRADAS',
                LANG_ENTRADAS_INFRARED: 'Sensor infraroig',
                LANG_ENTRADAS_INFRARED_PIN: 'PIN#',
                LANG_ENTRADAS_INFRARED_TOOLTIP: 'Retorna el valor digital del sensor infraroig ENTRADAS',
                LANG_SALIDAS_LED: 'LED',
                LANG_SALIDAS_LED_PIN: 'PIN#',
                LANG_SALIDAS_LED_ON: 'ENCENDRE',
                LANG_SALIDAS_LED_OFF: 'APAGAR',
                LANG_SALIDAS_LED_TOOLTIP: 'LED ENTRADAS',
                LANG_ENTRADAS_PHOTORESISTOR: 'Sensor de LLum',
                LANG_ENTRADAS_PHOTORESISTOR_PIN: 'PIN#',
                LANG_ENTRADAS_PHOTORESISTOR_TOOLTIP: 'Retorna el valor analògic del sensor de llum fotorresistència).',
                LANG_SALIDAS_PIEZO_BUZZER: 'Brunzidor',
                LANG_SALIDAS_PIEZO_BUZZER_PIN: 'PIN#',
                LANG_SALIDAS_PIEZO_BUZZER_TONE: 'TO',
                LANG_SALIDAS_PIEZO_BUZZER_DO: 'DO',
                ...
                LANG_SALIDAS_PIEZO_BUZZERAV: 'Brunzidor avançat',
                LANG_SALIDAS_PIEZO_BUZZERAV_PIN: 'PIN#',
                LANG_SALIDAS_PIEZO_BUZZERAV_TONE: 'TO',
                LANG_SALIDAS_PIEZO_BUZZERAV_DURATION: 'Durada',
                LANG_SALIDAS_PIEZO_BUZZERAV_TOOLTIP: 'Brunzidor piezoelèctric avançat.',
                LANG_ENTRADAS_POTENTIOMETER: 'Potenciòmetre',
                LANG_ENTRADAS_POTENTIOMETER_PIN: 'PIN#',
                LANG_ENTRADAS_POTENTIOMETER_TOOLTIP: 'Potenciòmetre ENTRADAS.',
                //servo blocks :
        ...
        (function() {
            var language = {
                ...
                /*LANG_SALIDAS_BUTTONS: 'Botonera',
                LANG_SALIDAS_BUTTONS_PIN: 'PIN#',
                LANG_SALIDAS_BUTTONS_BUTTON_A: 'Botón #A',
                LANG_SALIDAS_BUTTONS_BUTTON_B: 'Botón #B',
                LANG_SALIDAS_BUTTONS_BUTTON_C: 'Botón #C',
                LANG_SALIDAS_BUTTONS_BUTTON_D: 'Botón #D',
                LANG_SALIDAS_BUTTONS_BUTTON_E: 'Botón #E',
                LANG_SALIDAS_BUTTONS_TOOLTIP: 'Botonera',*/
                ...
                LANG_SALIDAS_MOTOR_PIN1: 'PINIZ#',
                LANG_SALIDAS_MOTOR_PIN2: 'PINDE#',
                ...
                LANG_ENTRADAS_LLUVIA: 'Sensor de lluvia',
                LANG_ENTRADAS_LLUVIA_PIN: 'PIN#',
                LANG_ENTRADAS_LLUVIA_TOOLTIP: 'Devuelve el valor analogico del sensor de lluvia',
        ...
        (function() {
            var language = {
                ...
                LANG_SALIDAS_BLUETOOTH_RECEIVE: 'Bluetooth: Jaso ',
                LANG_SALIDAS_BLUETOOTH_RECEIVE_BLUETOOTH: 'Bluetooth',
                LANG_SALIDAS_BLUETOOTH_RECEIVE_TOOLTIP: 'Bluetooth moduluak jasotako datuak bueltatzen ditu.',
                LANG_SALIDAS_BLUETOOTH_SEND: 'Bluetooth: Bidali',
                LANG_SALIDAS_BLUETOOTH_SEND_SEND: 'Datuak bidali',
                LANG_SALIDAS_BLUETOOTH_SEND_TOOLTIP: 'Sarreratik datuak hartu eta bluetooth modulua erabiliz bidaltzen ditu',
                LANG_SALIDAS_BLUETOOTH_DEF: 'Bluetooth',
                LANG_SALIDAS_BLUETOOTH_DEF_BAUD_RATE: 'Baudio-tasa',
                LANG_SALIDAS_BLUETOOTH_DEF_PIN1: 'RX',
                LANG_SALIDAS_BLUETOOTH_DEF_PIN2: 'TX',
                LANG_SALIDAS_BLUETOOTH_DEF_NAME: 'Izena',
                LANG_SALIDAS_BLUETOOTH_DEF_PINCODE: 'PIN kodea',
                LANG_SALIDAS_BLUETOOTH_DEF_RECEIVE: 'Jaso',
                LANG_SALIDAS_BLUETOOTH_DEF_SEND: 'Bidali',
                LANG_SALIDAS_BLUETOOTH_DEF_TOOLTIP: 'Bluetooth moduluaren definizioa',
                ...
                //SALIDAS blocks :
                LANG_CATEGORY_SALIDAS: 'Octopus blokeak',
                LANG_ENTRADAS_ULTRASONIDO: 'BAT - Ultrasoinuen sentsorea',
                LANG_ENTRADAS_ULTRASONIDO_RED_PIN: 'ECHO PIN#',
                LANG_ENTRADAS_ULTRASONIDO_BLUE_PIN: 'TRIGGER PIN#',
                LANG_ENTRADAS_ULTRASONIDO_TOOLTIP: 'Sentsoreak neurtutako distantzia bueltatzen du.',
                LANG_SALIDAS_BUTTON: 'Botoia',
                LANG_SALIDAS_BUTTON_PIN: 'PIN#',
                LANG_SALIDAS_BUTTON_TOOLTIP: 'Botoia',
                LANG_SALIDAS_BUTTONS: 'Botoi-multzoa',
                LANG_SALIDAS_BUTTONS_PIN: 'PIN#',
                LANG_SALIDAS_BUTTONS_BUTTON_A: '#A botoia',
                LANG_SALIDAS_BUTTONS_BUTTON_B: '#B botoia',
                LANG_SALIDAS_BUTTONS_BUTTON_C: '#C botoia',
                LANG_SALIDAS_BUTTONS_BUTTON_D: '#D botoia',
                LANG_SALIDAS_BUTTONS_BUTTON_E: '#E botoia',
                LANG_SALIDAS_BUTTONS_TOOLTIP: 'Botoi-multzoa',
                LANG_ENTRADAS_PIR: 'Infragorrien sentsorea',
                LANG_ENTRADAS_PIR_PIN: 'PIN#',
                LANG_ENTRADAS_PIR_TOOLTIP: 'Infragorrien sentsoreak neurtutako balio digitala bueltatzen du',
                LANG_SALIDAS_JOYSTICK: 'Joystick',
                LANG_SALIDAS_JOYSTICK_PIN_X: 'X ardatza PIN#',
                LANG_SALIDAS_JOYSTICK_PIN_Y: 'Y ardatza PIN#',
                LANG_SALIDAS_JOYSTICK_POSITION: 'Joystick-aren posizioa',
                LANG_SALIDAS_JOYSTICK_PIN_BUTTON: 'PIN# pultsadorea',
                LANG_SALIDAS_JOYSTICK_TOOLTIP: 'Joystick',
                LANG_SALIDAS_LED: 'LED',
                LANG_SALIDAS_LED_PIN: 'PIN#',
                LANG_SALIDAS_LED_STATE: '',
                LANG_SALIDAS_LED_ON: 'PIZTU',
                LANG_SALIDAS_LED_OFF: 'ITZALI',
                LANG_SALIDAS_LED_TOOLTIP: 'LED',
                LANG_SALIDAS_PHOTORESISTOR: 'Argi-sentsorea',
                LANG_SALIDAS_PHOTORESISTOR_PIN: 'PIN#',
                LANG_SALIDAS_PHOTORESISTOR_TOOLTIP: 'Fotorresistentziak neurtutako balio analogikoa bueltatzen du.',
                LANG_SALIDAS_PIEZO_BUZZER: 'Burrunbagailua',
                LANG_SALIDAS_PIEZO_BUZZER_PIN: 'PIN#',
                LANG_SALIDAS_PIEZO_BUZZER_TONE: 'TONUA',
                LANG_SALIDAS_PIEZO_BUZZER_DO: 'DO',
                LANG_SALIDAS_PIEZO_BUZZER_RE: 'RE',
                LANG_SALIDAS_PIEZO_BUZZER_MI: 'MI',
                LANG_SALIDAS_PIEZO_BUZZER_FA: 'FA',
                ...
                LANG_SALIDAS_PIEZO_BUZZER_LA: 'LA',
                LANG_SALIDAS_PIEZO_BUZZER_SI: 'SI',
                LANG_SALIDAS_PIEZO_BUZZER_DURATION: 'Iraupena [ms]',
                LANG_SALIDAS_PIEZO_BUZZER_TOOLTIP: 'Burrunbagailu piezoeléctrikoa',
                LANG_SALIDAS_PIEZO_BUZZERAV: 'Burrunbagailu aurreratua',
                LANG_SALIDAS_PIEZO_BUZZERAV_PIN: 'PIN#',
                LANG_SALIDAS_PIEZO_BUZZERAV_TONE: 'TONUA',
                LANG_SALIDAS_PIEZO_BUZZERAV_DURATION: 'Iraupena [ms]',
                LANG_SALIDAS_PIEZO_BUZZERAV_TOOLTIP: 'Burrunbagailu aurreratua',
                LANG_SALIDAS_POTENTIOMETER: 'Potentziometroa',
                LANG_SALIDAS_POTENTIOMETER_PIN: 'PIN#',
                LANG_SALIDAS_POTENTIOMETER_TOOLTIP: 'Potentziometroak neurtutako balio analogikoa bueltatzen du',
                //LCD blocks:
                ...
                LANG_VARIABLES_TYPE_STRING: 'String', // To translate
                //ENTRADAS blocks :
                LANG_CATEGORY_ENTRADAS: 'ENTRADAS blokeak',
                LANG_ENTRADAS_BUTTON: 'Botoia',
                LANG_ENTRADAS_BUTTON_PIN: 'PIN#',
                LANG_ENTRADAS_BUTTON_TOOLTIP: 'ENTRADAS botoia',
                LANG_ENTRADAS_FOLLOWER: 'Infragorrien sentsorea',
                LANG_ENTRADAS_FOLLOWER_PIN_LEFT: 'PIN EZKERRA#',
                LANG_ENTRADAS_FOLLOWER_PIN_RIGHT: 'PIN ESKUINA#',
                LANG_ENTRADAS_FOLLOWER_LEFT: 'Ezkerra',
                LANG_ENTRADAS_FOLLOWER_RIGHT: 'Eskuina',
                LANG_ENTRADAS_FOLLOWER_TOOLTIP: 'ENTRADAS infragorrien sentsorearen balio digitala bueltatzen du.',
                LANG_ENTRADAS_INFRARED: 'Infragorrien sentsorea',
                LANG_ENTRADAS_INFRARED_PIN: 'PIN#',
                LANG_ENTRADAS_INFRARED_TOOLTIP: 'ENTRADAS infragorrien sentsorearen balio digitala bueltatzen du.',
                LANG_SALIDAS_LED: 'LED',
                LANG_SALIDAS_LED_PIN: 'PIN#',
                LANG_SALIDAS_LED_ON: 'PIZTU',
                LANG_SALIDAS_LED_OFF: 'ITZALI',
                LANG_SALIDAS_LED_TOOLTIP: 'ENTRADAS LED',
                LANG_ENTRADAS_PHOTORESISTOR: 'Argi sentsorea',
                LANG_ENTRADAS_PHOTORESISTOR_PIN: 'PIN#',
                LANG_ENTRADAS_PHOTORESISTOR_TOOLTIP: 'Argi sentsorearen (fotorresistentzia) balio analogikoa bueltatzen du.',
                LANG_SALIDAS_PIEZO_BUZZER: 'Burrunbagailua',
                LANG_SALIDAS_PIEZO_BUZZER_PIN: 'PIN#',
                LANG_SALIDAS_PIEZO_BUZZER_TONE: 'TONUA',
                LANG_SALIDAS_PIEZO_BUZZER_DO: 'DO',
                ...
                LANG_SALIDAS_PIEZO_BUZZER_SI: 'SI',
                LANG_SALIDAS_PIEZO_BUZZER_DURATION: 'Iraupena [ms]',
                LANG_SALIDAS_PIEZO_BUZZER_TOOLTIP: 'Burrunbagailu piezoelektrikoa',
                LANG_SALIDAS_PIEZO_BUZZERAV: 'Burrunbagailu aurreratua',
                LANG_SALIDAS_PIEZO_BUZZERAV_PIN: 'PIN#',
                LANG_SALIDAS_PIEZO_BUZZERAV_TONE: 'TONUA',
                LANG_SALIDAS_PIEZO_BUZZERAV_DURATION: 'Iraupena [ms]',
                LANG_SALIDAS_PIEZO_BUZZERAV_TOOLTIP: 'Burrunbagailu piezoelektriko aurreratua.',
                LANG_ENTRADAS_POTENTIOMETER: 'Potentziometroa',
                LANG_ENTRADAS_POTENTIOMETER_PIN: 'PIN#',
                LANG_ENTRADAS_POTENTIOMETER_TOOLTIP: 'ENTRADAS potentziometroa.',
                //servo blocks :
        ...
        (function() {
            var language = {
                ...
                //communication blocks:
                LANG_CATEGORY_COMMUNICATION: 'Communication',
                LANG_SALIDAS_BLUETOOTH_RECEIVE: 'Bluetooth : recevoir',
                LANG_SALIDAS_BLUETOOTH_RECEIVE_BLUETOOTH: 'Bluetooth',
                LANG_SALIDAS_BLUETOOTH_RECEIVE_TOOLTIP: 'Renvoie les données reçues par le module Bluetooth',
                LANG_SALIDAS_BLUETOOTH_SEND: 'Bluetooth : envoyer',
                LANG_SALIDAS_BLUETOOTH_SEND_SEND: 'Envoyer',
                LANG_SALIDAS_BLUETOOTH_SEND_TOOLTIP: 'Envoie les données via le module Bluetooth',
                LANG_SALIDAS_BLUETOOTH_DEF: 'Définition du Bluetooth',
                LANG_SALIDAS_BLUETOOTH_DEF_BAUD_RATE: 'Débit (bauds)',
                LANG_SALIDAS_BLUETOOTH_DEF_PIN1: 'RX',
                LANG_SALIDAS_BLUETOOTH_DEF_PIN2: 'TX',
                LANG_SALIDAS_BLUETOOTH_DEF_NAME: 'Nom',
                LANG_SALIDAS_BLUETOOTH_DEF_PINCODE: 'CodePin',
                LANG_SALIDAS_BLUETOOTH_DEF_RECEIVE: 'Recevoir',
                LANG_SALIDAS_BLUETOOTH_DEF_SEND: 'Envoyer',
                LANG_SALIDAS_BLUETOOTH_DEF_TOOLTIP: 'Définition du module Bluetooth',
                ...
                //SALIDAS blocks :
                LANG_CATEGORY_SALIDAS: 'Octopus bloqs',
                LANG_ENTRADAS_ULTRASONIDO: 'BAT – Capteur à ultrasons',
                LANG_ENTRADAS_ULTRASONIDO_RED_PIN: 'BROCHE ECHO#',
                LANG_ENTRADAS_ULTRASONIDO_BLUE_PIN: 'BROCHE TRIGGER#',
                LANG_ENTRADAS_ULTRASONIDO_TOOLTIP: 'Renvoie la distance mesurée par le capteur à ultrasons.',
                LANG_SALIDAS_BUTTON: 'Bouton',
                LANG_SALIDAS_BUTTON_PIN: 'BROCHE#',
                LANG_SALIDAS_BUTTON_TOOLTIP: 'Bouton',
                LANG_SALIDAS_BUTTONS: 'Plaque de boutons',
                LANG_SALIDAS_BUTTONS_PIN: 'BROCHE#',
                LANG_SALIDAS_BUTTONS_BUTTON_A: 'Bouton #A',
                LANG_SALIDAS_BUTTONS_BUTTON_B: 'Bouton #B',
                LANG_SALIDAS_BUTTONS_BUTTON_C: 'Bouton #C',
                LANG_SALIDAS_BUTTONS_BUTTON_D: 'Bouton #D',
                LANG_SALIDAS_BUTTONS_BUTTON_E: 'Bouton #E',
                LANG_SALIDAS_BUTTONS_TOOLTIP: 'Plaque de boutons',
                LANG_ENTRADAS_PIR: 'Capteur infrarouge',
                LANG_ENTRADAS_PIR_PIN: 'BROCHE#',
                LANG_ENTRADAS_PIR_TOOLTIP: 'Renvoie la valeur numérique lue par le capteur infrarouge.',
                LANG_SALIDAS_JOYSTICK: 'Joystick',
                LANG_SALIDAS_JOYSTICK_PIN_X: 'Axe X BROCHE#',
                LANG_SALIDAS_JOYSTICK_PIN_Y: 'Axe Y BROCHE#',
                LANG_SALIDAS_JOYSTICK_PIN_BUTTON: 'Bouton-poussoir BROCHE#',
                LANG_SALIDAS_JOYSTICK_POSITION: 'Position du joystick',
                LANG_SALIDAS_JOYSTICK_TOOLTIP: 'Joystick',
                LANG_SALIDAS_LED: 'LED',
                LANG_SALIDAS_LED_PIN: 'BROCHE#',
                LANG_SALIDAS_LED_STATE: '',
                LANG_SALIDAS_LED_ON: 'ON',
                LANG_SALIDAS_LED_OFF: 'OFF',
                LANG_SALIDAS_LED_TOOLTIP: 'LED',
                LANG_SALIDAS_PHOTORESISTOR: 'Capteur de luminosité',
                LANG_SALIDAS_PHOTORESISTOR_PIN: 'BROCHE#',
                LANG_SALIDAS_PHOTORESISTOR_TOOLTIP: 'Renvoie la valeur analogique mesurée par le capteur de luminosité.',
                LANG_SALIDAS_PIEZO_BUZZER: 'Buzzer',
                LANG_SALIDAS_PIEZO_BUZZER_PIN: 'BROCHE#',
                LANG_SALIDAS_PIEZO_BUZZER_TONE: 'TONALITÉ',
                LANG_SALIDAS_PIEZO_BUZZER_DO: 'DO',
                LANG_SALIDAS_PIEZO_BUZZER_RE: 'RÉ',
                LANG_SALIDAS_PIEZO_BUZZER_MI: 'MI',
                LANG_SALIDAS_PIEZO_BUZZER_FA: 'FA',
                LANG_SALIDAS_PIEZO_BUZZER_SOL: 'SOL',
                LANG_SALIDAS_PIEZO_BUZZER_LA: 'LA',
                LANG_SALIDAS_PIEZO_BUZZER_SI: 'SI',
                LANG_SALIDAS_PIEZO_BUZZER_DURATION: 'Durée [ms]',
                LANG_SALIDAS_PIEZO_BUZZER_TOOLTIP: 'Buzzer',
                LANG_SALIDAS_PIEZO_BUZZERAV: 'Buzzer avancé',
                LANG_SALIDAS_PIEZO_BUZZERAV_PIN: 'BROCHE#',
                LANG_SALIDAS_PIEZO_BUZZERAV_TONE: 'TONALITÉ',
                LANG_SALIDAS_PIEZO_BUZZERAV_DURATION: 'Durée [ms]',
                LANG_SALIDAS_PIEZO_BUZZERAV_TOOLTIP: 'Buzzer avancé',
                LANG_SALIDAS_POTENTIOMETER: 'Potentiomètre',
                LANG_SALIDAS_POTENTIOMETER_PIN: 'BROCHE#',
                LANG_SALIDAS_POTENTIOMETER_TOOLTIP: 'Renvoie la valeur analogique mesurée par le potentiomètre.',
                //LCD blocks:
                ...
                //ENTRADAS blocks :
                LANG_CATEGORY_ENTRADAS: 'ENTRADAS bloqs',
                LANG_ENTRADAS_BUTTON: 'Bouton',
                LANG_ENTRADAS_BUTTON_PIN: 'BROCHE#',
                LANG_ENTRADAS_BUTTON_TOOLTIP: 'Bouton ENTRADAS',
                LANG_ENTRADAS_FOLLOWER: 'Capteur infrarouge',
                LANG_ENTRADAS_FOLLOWER_PIN_LEFT: 'BROCHE GAUCHE#',
                LANG_ENTRADAS_FOLLOWER_PIN_RIGHT: 'BROCHE DROITE#',
                LANG_ENTRADAS_FOLLOWER_LEFT: 'Gauche',
                LANG_ENTRADAS_FOLLOWER_RIGHT: 'Droite',
                LANG_ENTRADAS_FOLLOWER_TOOLTIP: 'Renvoie la valeur numérique lue par le capteur infrarouge',
                LANG_ENTRADAS_INFRARED: 'Capteur infrarouge',
                LANG_ENTRADAS_INFRARED_PIN: 'BROCHE#',
                LANG_ENTRADAS_INFRARED_TOOLTIP: 'Renvoie la valeur numérique lue par le capteur infrarouge',
                LANG_SALIDAS_LED: 'LED',
                LANG_SALIDAS_LED_PIN: 'BROCHE#',
                LANG_SALIDAS_LED_ON: 'ON',
                LANG_SALIDAS_LED_OFF: 'OFF',
                LANG_SALIDAS_LED_TOOLTIP: 'LED ENTRADAS',
                LANG_ENTRADAS_PHOTORESISTOR: 'Capteur de luminosité',
                LANG_ENTRADAS_PHOTORESISTOR_PIN: 'BROCHE#',
                LANG_ENTRADAS_PHOTORESISTOR_TOOLTIP: 'Renvoie la valeur analogique mesurée par le capteur de luminosité.',
                LANG_SALIDAS_PIEZO_BUZZER: 'Buzzer',
                LANG_SALIDAS_PIEZO_BUZZER_PIN: 'BROCHE#',
                LANG_SALIDAS_PIEZO_BUZZER_TONE: 'TONALITÉ',
                LANG_SALIDAS_PIEZO_BUZZER_DO: 'DO',
                ...
                LANG_SALIDAS_PIEZO_BUZZERAV_DURATION: 'Durée [ms]',
                LANG_SALIDAS_PIEZO_BUZZERAV_TOOLTIP: 'Buzzer avancé',
                LANG_ENTRADAS_POTENTIOMETER: 'Potentiomètre',
                LANG_ENTRADAS_POTENTIOMETER_PIN: 'BROCHE#',
                LANG_ENTRADAS_POTENTIOMETER_TOOLTIP: 'Renvoie la valeur analogue mesurée par le potentiomètre.',
                //servo blocks :
                LANG_CATEGORY_SERVO: 'Servo',
        ...
        (function() {
            var language = {
                ...
                LANG_SALIDAS_BLUETOOTH_RECEIVE: 'Ricezione dati da Bluetooth',
                LANG_SALIDAS_BLUETOOTH_RECEIVE_BLUETOOTH: 'Bluetooth',
                LANG_SALIDAS_BLUETOOTH_RECEIVE_TOOLTIP: 'Restituisce i dati ricevuti dal modulo Bluetooth',
                LANG_SALIDAS_BLUETOOTH_SEND: 'Invio dati a Bluetooth',
                LANG_SALIDAS_BLUETOOTH_SEND_SEND: 'Invia',
                LANG_SALIDAS_BLUETOOTH_SEND_TOOLTIP: 'Invia dati usando il modulo Bluetooth',
                LANG_SALIDAS_BLUETOOTH_DEF: 'Definizione Bluetooth',
                LANG_SALIDAS_BLUETOOTH_DEF_BAUD_RATE: 'Velocità di trasmissione',
                LANG_SALIDAS_BLUETOOTH_DEF_PIN1: 'RX',
                LANG_SALIDAS_BLUETOOTH_DEF_PIN2: 'TX',
                LANG_SALIDAS_BLUETOOTH_DEF_NAME: 'Nome',
                LANG_SALIDAS_BLUETOOTH_DEF_PINCODE: 'Codice pin',
                LANG_SALIDAS_BLUETOOTH_DEF_RECEIVE: 'Ricevi',
                LANG_SALIDAS_BLUETOOTH_DEF_SEND: 'Invia',
                LANG_SALIDAS_BLUETOOTH_DEF_TOOLTIP: 'Definizione del modulo Bluetooth',
                ...
                //SALIDAS blocks :
                LANG_CATEGORY_SALIDAS: 'Octopus bloqs',
                LANG_ENTRADAS_ULTRASONIDO: 'BAT - Sensore ad ultrasuoni',
                LANG_ENTRADAS_ULTRASONIDO_RED_PIN: 'ECHO PIN#',
                LANG_ENTRADAS_ULTRASONIDO_BLUE_PIN: 'TRIGGER PIN#',
                LANG_ENTRADAS_ULTRASONIDO_TOOLTIP: 'Restituisce la distanza misurata dal sensore ad ultrasuoni.',
                LANG_SALIDAS_BUTTON: 'Pulsante',
                LANG_SALIDAS_BUTTON_PIN: 'PIN#',
                LANG_SALIDAS_BUTTON_TOOLTIP: 'Pulsante',
                LANG_SALIDAS_BUTTONS: 'Pad dei pulsanti',
                LANG_SALIDAS_BUTTONS_PIN: 'PIN#',
                LANG_SALIDAS_BUTTONS_BUTTON_A: 'Pulsante #A',
                LANG_SALIDAS_BUTTONS_BUTTON_B: 'Pulsante #B',
                LANG_SALIDAS_BUTTONS_BUTTON_C: 'Pulsante #C',
                LANG_SALIDAS_BUTTONS_BUTTON_D: 'Pulsante #D',
                LANG_SALIDAS_BUTTONS_BUTTON_E: 'Pulsante #E',
                LANG_SALIDAS_BUTTONS_TOOLTIP: 'Pulsante Pad',
                LANG_ENTRADAS_PIR: 'Sensore ad infrarossi',
                LANG_ENTRADAS_PIR_PIN: 'PIN#',
                LANG_ENTRADAS_PIR_TOOLTIP: 'Restituisce il valore digitale letto dal sensore ad infrarossi.',
                LANG_SALIDAS_JOYSTICK: 'Joystick',
                LANG_SALIDAS_JOYSTICK_PIN_X: 'Asse X PIN#',
                LANG_SALIDAS_JOYSTICK_PIN_Y: 'Asse Y PIN#',
                LANG_SALIDAS_JOYSTICK_PIN_BUTTON: 'Pulsante PIN#',
                LANG_SALIDAS_JOYSTICK_POSITION: 'Posizione joystick',
                LANG_SALIDAS_JOYSTICK_TOOLTIP: 'Joystick',
                LANG_SALIDAS_LED: 'LED',
                LANG_SALIDAS_LED_PIN: 'PIN#',
                LANG_SALIDAS_LED_STATE: '',
                LANG_SALIDAS_LED_ON: 'ACCESO',
                LANG_SALIDAS_LED_OFF: 'SPENTO',
                LANG_SALIDAS_LED_TOOLTIP: 'LED',
                LANG_SALIDAS_PHOTORESISTOR: 'Sensore di luce',
                LANG_SALIDAS_PHOTORESISTOR_PIN: 'PIN#',
                LANG_SALIDAS_PHOTORESISTOR_TOOLTIP: 'Restituisce il valore analogico misurato dal sensore di luce.',
                LANG_SALIDAS_PIEZO_BUZZER: 'Buzzer',
                LANG_SALIDAS_PIEZO_BUZZER_PIN: 'PIN#',
                LANG_SALIDAS_PIEZO_BUZZER_TONE: 'TONO',
                LANG_SALIDAS_PIEZO_BUZZER_DO: 'DO',
                ...
                LANG_SALIDAS_PIEZO_BUZZER_LA: 'LA',
                LANG_SALIDAS_PIEZO_BUZZER_SI: 'SI',
                LANG_SALIDAS_PIEZO_BUZZER_DURATION: 'Durata',
                LANG_SALIDAS_PIEZO_BUZZER_TOOLTIP: 'Buzzer',
                LANG_SALIDAS_PIEZO_BUZZERAV: 'Buzzer avanzato',
                LANG_SALIDAS_PIEZO_BUZZERAV_PIN: 'PIN#',
                LANG_SALIDAS_PIEZO_BUZZERAV_TONE: 'TONO',
                LANG_SALIDAS_PIEZO_BUZZERAV_DURATION: 'Durata',
                LANG_SALIDAS_PIEZO_BUZZERAV_TOOLTIP: 'Buzzer avanzato',
                LANG_SALIDAS_POTENTIOMETER: 'Potenziometro',
                LANG_SALIDAS_POTENTIOMETER_PIN: 'PIN#',
                LANG_SALIDAS_POTENTIOMETER_TOOLTIP: 'Restituisce il valore analogico del potenziometro.',
                //LCD blocks:
                LANG_CATEGORY_LCD: 'LCD bloqs',
                LANG_LCD_DEF: 'LCD (2x16)',
                LANG_LCD_PINS: 'LCD Pins',
                ...
                //ENTRADAS blocks :
                LANG_CATEGORY_ENTRADAS: 'ENTRADAS bloqs',
                LANG_ENTRADAS_BUTTON: 'Pulsante',
                LANG_ENTRADAS_BUTTON_PIN: 'PIN#',
                LANG_ENTRADAS_BUTTON_TOOLTIP: 'Pulsante ENTRADAS',
                LANG_ENTRADAS_FOLLOWER: 'Sensore a infrarossi',
                LANG_ENTRADAS_FOLLOWER_PIN_LEFT: 'PIN SINISTRO#',
                LANG_ENTRADAS_FOLLOWER_PIN_RIGHT: 'PIN DESTRO#',
                LANG_ENTRADAS_FOLLOWER_LEFT: 'Sinistra',
                LANG_ENTRADAS_FOLLOWER_RIGHT: 'Destra',
                LANG_ENTRADAS_FOLLOWER_TOOLTIP: 'Restituisce il valore digitale letto dal sensore ad infrarossi',
                LANG_ENTRADAS_INFRARED: 'Sensore ad infrarossi',
                LANG_ENTRADAS_INFRARED_PIN: 'PIN#',
                LANG_ENTRADAS_INFRARED_TOOLTIP: 'Restituisce il valore digitale letto dal sensore ad infrarossi',
                LANG_SALIDAS_LED: 'LED',
                LANG_SALIDAS_LED_PIN: 'PIN#',
                LANG_SALIDAS_LED_ON: 'ACCESO',
                LANG_SALIDAS_LED_OFF: 'SPENTO',
                LANG_SALIDAS_LED_TOOLTIP: 'LED ENTRADAS',
                LANG_ENTRADAS_PHOTORESISTOR: 'Sensore di luce',
                LANG_ENTRADAS_PHOTORESISTOR_PIN: 'PIN#',
                LANG_ENTRADAS_PHOTORESISTOR_TOOLTIP: 'Restituisce il valore analogico misurato dal sensore di luce.',
                LANG_SALIDAS_PIEZO_BUZZER: 'Buzzer',
                LANG_SALIDAS_PIEZO_BUZZER_PIN: 'PIN#',
                LANG_SALIDAS_PIEZO_BUZZER_TONE: 'TONO',
                LANG_SALIDAS_PIEZO_BUZZER_DO: 'DO',
                ...
                LANG_SALIDAS_PIEZO_BUZZERAV_DURATION: 'Durata',
                LANG_SALIDAS_PIEZO_BUZZERAV_TOOLTIP: 'Buzzer avanzato',
                LANG_ENTRADAS_POTENTIOMETER: 'Potenziometro',
                LANG_ENTRADAS_POTENTIOMETER_PIN: 'PIN#',
                LANG_ENTRADAS_POTENTIOMETER_TOOLTIP: 'Restituisce il valore analogico del potenziometro.',
                //servo blocks :
                LANG_CATEGORY_SERVO: 'Servo',
        ...
        (function() {
            var language = {
                ...
                LANG_SALIDAS_BLUETOOTH_RECEIVE: 'Odbiera dane przez Bluetooth',
                LANG_SALIDAS_BLUETOOTH_RECEIVE_BLUETOOTH: 'Bluetooth',
                LANG_SALIDAS_BLUETOOTH_RECEIVE_TOOLTIP: 'Zwraca dane odebrane przez moduł Bluetooth',
                LANG_SALIDAS_BLUETOOTH_SEND: 'Nadaje dane przez Bluetooth',
                LANG_SALIDAS_BLUETOOTH_SEND_SEND: 'Nadajnik',
                LANG_SALIDAS_BLUETOOTH_SEND_TOOLTIP: 'Wysyła dane wejściowe przez moduł Bluetooth',
                LANG_SALIDAS_BLUETOOTH_DEF: 'Definicja Bluetooth',
                LANG_SALIDAS_BLUETOOTH_DEF_BAUD_RATE: 'Prędkość transmisji',
                LANG_SALIDAS_BLUETOOTH_DEF_PIN1: 'RX',
                LANG_SALIDAS_BLUETOOTH_DEF_PIN2: 'TX',
                LANG_SALIDAS_BLUETOOTH_DEF_NAME: 'Nazwa',
                LANG_SALIDAS_BLUETOOTH_DEF_PINCODE: 'PinCode',
                LANG_SALIDAS_BLUETOOTH_DEF_RECEIVE: 'Odbierz',
                LANG_SALIDAS_BLUETOOTH_DEF_SEND: 'Wyślij',
                LANG_SALIDAS_BLUETOOTH_DEF_TOOLTIP: 'Definicja modułu Bluetooth',
                ...
                //bloki SALIDAS:
                LANG_CATEGORY_SALIDAS: 'Bloki Octopus',
                LANG_ENTRADAS_ULTRASONIDO: 'BAT - czujnik ultradźwiękowy',
                LANG_ENTRADAS_ULTRASONIDO_RED_PIN: 'Echo PIN#',
                LANG_ENTRADAS_ULTRASONIDO_BLUE_PIN: 'Wyzwalacz PIN#',
                LANG_ENTRADAS_ULTRASONIDO_TOOLTIP: 'Zwraca odległość zmierzoną przez czujnik ultradźwiękowy.',
                LANG_SALIDAS_BUTTON: 'Przycisk',
                LANG_SALIDAS_BUTTON_PIN: 'PIN#',
                LANG_SALIDAS_BUTTON_TOOLTIP: 'Przycisk',
                LANG_SALIDAS_BUTTONS: 'Płytka przycisków',
                LANG_SALIDAS_BUTTONS_PIN: 'PIN#',
                LANG_SALIDAS_BUTTONS_BUTTON_A: 'Przycisk #A',
                LANG_SALIDAS_BUTTONS_BUTTON_B: 'Przycisk #B',
                LANG_SALIDAS_BUTTONS_BUTTON_C: 'Przycisk #C',
                LANG_SALIDAS_BUTTONS_BUTTON_D: 'Przycisk #D',
                LANG_SALIDAS_BUTTONS_BUTTON_E: 'Przycisk #E',
                LANG_SALIDAS_BUTTONS_TOOLTIP: 'Płytka zestawu przycisków',
                LANG_ENTRADAS_PIR: 'Czujnik podczerwieni',
                LANG_ENTRADAS_PIR_PIN: 'PIN#',
                LANG_ENTRADAS_PIR_TOOLTIP: 'Zwraca wartość cyfrową odczytaną przez czujnik podczerwieni.',
                LANG_SALIDAS_JOYSTICK: 'Dżojstik',
                LANG_SALIDAS_JOYSTICK_PIN_X: 'Oś X PIN#',
                LANG_SALIDAS_JOYSTICK_PIN_Y: 'Oś Y PIN#',
                LANG_SALIDAS_JOYSTICK_PIN_BUTTON: 'Przycisk PIN#',
                LANG_SALIDAS_JOYSTICK_POSITION: 'Pozycja dżojstika',
                LANG_SALIDAS_JOYSTICK_TOOLTIP: 'Dżojstik dwuosiowy z 1 przyciskiem.',
                LANG_SALIDAS_LED: 'LED',
                LANG_SALIDAS_LED_PIN: 'PIN#',
                LANG_SALIDAS_LED_STATE: 'Stan LED',
                LANG_SALIDAS_LED_ON: 'włączona',
                LANG_SALIDAS_LED_OFF: 'wyłączona',
                LANG_SALIDAS_LED_TOOLTIP: 'Dioda świecąca LED.',
                LANG_SALIDAS_PHOTORESISTOR: 'Czujnik światła',
                LANG_SALIDAS_PHOTORESISTOR_PIN: 'PIN#',
                LANG_SALIDAS_PHOTORESISTOR_TOOLTIP: 'Zwraca wartość analogową zmierzoną przez czujnik światła.',
                LANG_SALIDAS_PIEZO_BUZZER: 'Brzęczyk',
                LANG_SALIDAS_PIEZO_BUZZER_PIN: 'PIN#',
                LANG_SALIDAS_PIEZO_BUZZER_TONE: 'Ton',
                LANG_SALIDAS_PIEZO_BUZZER_DO: 'do',
                LANG_SALIDAS_PIEZO_BUZZER_RE: 're',
                LANG_SALIDAS_PIEZO_BUZZER_MI: 'mi',
                LANG_SALIDAS_PIEZO_BUZZER_FA: 'fa',
                ...
                LANG_SALIDAS_PIEZO_BUZZER_LA: 'la',
                LANG_SALIDAS_PIEZO_BUZZER_SI: 'si',
                LANG_SALIDAS_PIEZO_BUZZER_DURATION: 'Czas trwania [ms]',
                LANG_SALIDAS_PIEZO_BUZZER_TOOLTIP: 'Brzęczyk piezoelektryczny',
                LANG_SALIDAS_PIEZO_BUZZERAV: 'Brzęczyk zaawansowany',
                LANG_SALIDAS_PIEZO_BUZZERAV_PIN: 'PIN#',
                LANG_SALIDAS_PIEZO_BUZZERAV_TONE: 'Ton',
                LANG_SALIDAS_PIEZO_BUZZERAV_DURATION: 'Czas trwania [ms]',
                LANG_SALIDAS_PIEZO_BUZZERAV_TOOLTIP: 'Brzęczyk piezoelektryczny zaawansowany',
                LANG_SALIDAS_POTENTIOMETER: 'Potencjometr',
                LANG_SALIDAS_POTENTIOMETER_PIN: 'PIN#',
                LANG_SALIDAS_POTENTIOMETER_TOOLTIP: 'Zwraca wartość analogową ustawioną na potencjometrze.',
                //bloki LCD:
                ...
                LANG_VARIABLES_TYPE_STRING: 'String', // To translate
                //bloki ENTRADAS:
                LANG_CATEGORY_ENTRADAS: 'Bloki ENTRADAS',
                LANG_ENTRADAS_BUTTON: 'Przycisk',
                LANG_ENTRADAS_BUTTON_PIN: 'PIN#',
                LANG_ENTRADAS_BUTTON_TOOLTIP: 'Przycisk ENTRADAS',
                LANG_ENTRADAS_FOLLOWER: 'Czujnik podczerwieni',
                LANG_ENTRADAS_FOLLOWER_PIN_LEFT: 'PIN LEFT#',
                LANG_ENTRADAS_FOLLOWER_PIN_RIGHT: 'PIN RIGHT#',
                LANG_ENTRADAS_FOLLOWER_LEFT: 'Lewy',
                LANG_ENTRADAS_FOLLOWER_RIGHT: 'Prawy',
                LANG_ENTRADAS_FOLLOWER_TOOLTIP: 'Zwraca wartość cyfrową odczytaną przez czujnik podczerwieni ENTRADAS',
                LANG_ENTRADAS_INFRARED: 'Czujnik podczerwieni',
                LANG_ENTRADAS_INFRARED_PIN: 'PIN#',
                LANG_ENTRADAS_INFRARED_TOOLTIP: 'Zwraca wartość cyfrową odczytaną przez czujnik podczerwieni ENTRADAS',
                LANG_SALIDAS_LED: 'Dioda LED',
                LANG_SALIDAS_LED_PIN: 'PIN#',
                LANG_SALIDAS_LED_ON: 'właczona',
                LANG_SALIDAS_LED_OFF: 'wyłączona',
                LANG_SALIDAS_LED_TOOLTIP: 'Dioda LED ENTRADAS',
                LANG_ENTRADAS_PHOTORESISTOR: 'Czujnik światła',
                LANG_ENTRADAS_PHOTORESISTOR_PIN: 'PIN#',
                LANG_ENTRADAS_PHOTORESISTOR_TOOLTIP: 'Zwraca wartość analogową zmierzoną przez czujnik światła ENTRADAS.',
                LANG_SALIDAS_PIEZO_BUZZER: 'Brzęczyk',
                LANG_SALIDAS_PIEZO_BUZZER_PIN: 'PIN#',
                LANG_SALIDAS_PIEZO_BUZZER_TONE: 'Ton',
                LANG_SALIDAS_PIEZO_BUZZER_DO: 'do',
                ...
                LANG_SALIDAS_PIEZO_BUZZER_SI: 'si',
                LANG_SALIDAS_PIEZO_BUZZER_DURATION: 'Czas trwania [ms]',
                LANG_SALIDAS_PIEZO_BUZZER_TOOLTIP: 'Brzęczyk piezoelektryczny ENTRADAS',
                LANG_SALIDAS_PIEZO_BUZZERAV: 'Brzęczyk zaawansowany',
                LANG_SALIDAS_PIEZO_BUZZERAV_PIN: 'PIN#',
                LANG_SALIDAS_PIEZO_BUZZERAV_TONE: 'Ton',
                LANG_SALIDAS_PIEZO_BUZZERAV_DURATION: 'Czas trwania [ms]',
                LANG_SALIDAS_PIEZO_BUZZERAV_TOOLTIP: 'Brzęczyk piezoelektryczny ENTRADAS zaawansowany',
                LANG_ENTRADAS_POTENTIOMETER: 'Potencjometr',
                LANG_ENTRADAS_POTENTIOMETER_PIN: 'PIN#',
                LANG_ENTRADAS_POTENTIOMETER_TOOLTIP: 'Zwraca wartość analogową ustawioną na potencjometrze ENTRADAS.',
        ...
        (function() {
            var language = {
                ...
                LANG_SALIDAS_BLUETOOTH_RECEIVE: 'Bluetooth: receber ',
                LANG_SALIDAS_BLUETOOTH_RECEIVE_BLUETOOTH: 'Bluetooth',
                LANG_SALIDAS_BLUETOOTH_RECEIVE_TOOLTIP: 'Devolve os dados recebidos pelo módulo Bluetooth',
                LANG_SALIDAS_BLUETOOTH_SEND: 'Bluetooth: Enviar',
                LANG_SALIDAS_BLUETOOTH_SEND_SEND: 'Enviar dados',
                LANG_SALIDAS_BLUETOOTH_SEND_TOOLTIP: 'Os dados da entrada são enviados usando o módulo Bluetooth',
                LANG_SALIDAS_BLUETOOTH_DEF: 'Bluetooth',
                LANG_SALIDAS_BLUETOOTH_DEF_BAUD_RATE: 'Baud Rate',
                LANG_SALIDAS_BLUETOOTH_DEF_PIN1: 'RX',
                LANG_SALIDAS_BLUETOOTH_DEF_PIN2: 'TX',
                LANG_SALIDAS_BLUETOOTH_DEF_NAME: 'Nome',
                LANG_SALIDAS_BLUETOOTH_DEF_PINCODE: 'Código PIN',
                LANG_SALIDAS_BLUETOOTH_DEF_RECEIVE: 'Receber',
                LANG_SALIDAS_BLUETOOTH_DEF_SEND: 'Enviar',
                LANG_SALIDAS_BLUETOOTH_DEF_TOOLTIP: 'Definicão do módulo Bluetooth',
                ...
                //SALIDAS blocks :
                LANG_CATEGORY_SALIDAS: 'Octopus bloqs',
                LANG_ENTRADAS_ULTRASONIDO: 'BAT - Sensor de Ultrasons',
                LANG_ENTRADAS_ULTRASONIDO_RED_PIN: 'ECHO PIN#',
                LANG_ENTRADAS_ULTRASONIDO_BLUE_PIN: 'TRIGGER PIN#',
                LANG_ENTRADAS_ULTRASONIDO_TOOLTIP: 'Devolve a distância medida pelo sensor.',
                LANG_SALIDAS_BUTTON: 'Botão',
                LANG_SALIDAS_BUTTON_PIN: 'PIN#',
                LANG_SALIDAS_BUTTON_TOOLTIP: 'Botão',
                LANG_SALIDAS_BUTTONS: 'Botoneira',
                LANG_SALIDAS_BUTTONS_PIN: 'PIN#',
                LANG_SALIDAS_BUTTONS_BUTTON_A: 'Botão #A',
                LANG_SALIDAS_BUTTONS_BUTTON_B: 'Botão #B',
                LANG_SALIDAS_BUTTONS_BUTTON_C: 'Botão #C',
                LANG_SALIDAS_BUTTONS_BUTTON_D: 'Botão #D',
                LANG_SALIDAS_BUTTONS_BUTTON_E: 'Botão #E',
                LANG_SALIDAS_BUTTONS_TOOLTIP: 'Botoneira',
                LANG_ENTRADAS_PIR: 'Sensor infravermelhos',
                LANG_ENTRADAS_PIR_PIN: 'PIN#',
                LANG_ENTRADAS_PIR_TOOLTIP: 'Devolve o valor digital medido pelo sensor infravermelhos',
                LANG_SALIDAS_JOYSTICK: 'Joystick',
                LANG_SALIDAS_JOYSTICK_PIN_X: 'Eixo X PIN#',
                LANG_SALIDAS_JOYSTICK_PIN_Y: 'Eixo Y PIN#',
                LANG_SALIDAS_JOYSTICK_POSITION: 'Posição Joystick',
                LANG_SALIDAS_JOYSTICK_PIN_BUTTON: 'Botão PIN#',
                LANG_SALIDAS_JOYSTICK_TOOLTIP: 'Joystick',
                LANG_SALIDAS_LED: 'LED',
                LANG_SALIDAS_LED_PIN: 'PIN#',
                LANG_SALIDAS_LED_STATE: '',
                LANG_SALIDAS_LED_ON: 'ACENDER',
                LANG_SALIDAS_LED_OFF: 'APAGAR',
                LANG_SALIDAS_LED_TOOLTIP: 'LED',
                LANG_SALIDAS_PHOTORESISTOR: 'Sensor de Luz',
                LANG_SALIDAS_PHOTORESISTOR_PIN: 'PIN#',
                LANG_SALIDAS_PHOTORESISTOR_TOOLTIP: 'Devolve o valor analógico medido pela foto-resistência.',
                LANG_SALIDAS_PIEZO_BUZZER: 'Cigarra',
                LANG_SALIDAS_PIEZO_BUZZER_PIN: 'PIN#',
                LANG_SALIDAS_PIEZO_BUZZER_TONE: 'TOM',
                LANG_SALIDAS_PIEZO_BUZZER_DO: 'DO',
                LANG_SALIDAS_PIEZO_BUZZER_RE: 'RÉ',
                LANG_SALIDAS_PIEZO_BUZZER_MI: 'MI',
                LANG_SALIDAS_PIEZO_BUZZER_FA: 'FA',
                ...
                LANG_SALIDAS_PIEZO_BUZZER_LA: 'LA',
                LANG_SALIDAS_PIEZO_BUZZER_SI: 'SI',
                LANG_SALIDAS_PIEZO_BUZZER_DURATION: 'Duração',
                LANG_SALIDAS_PIEZO_BUZZER_TOOLTIP: 'Cigarra - Elemento piezoeléctrico',
                LANG_SALIDAS_PIEZO_BUZZERAV: 'Cigarra avançado',
                LANG_SALIDAS_PIEZO_BUZZERAV_PIN: 'PIN#',
                LANG_SALIDAS_PIEZO_BUZZERAV_TONE: 'TOM',
                LANG_SALIDAS_PIEZO_BUZZERAV_DURATION: 'Duração',
                LANG_SALIDAS_PIEZO_BUZZERAV_TOOLTIP: 'Cigarra avançado',
                LANG_SALIDAS_POTENTIOMETER: 'Potenciômetro',
                LANG_SALIDAS_POTENTIOMETER_PIN: 'PIN#',
                LANG_SALIDAS_POTENTIOMETER_TOOLTIP: 'Devolve o valor analógico medido pelo Potenciômetro',
                //LCD blocks:
                LANG_CATEGORY_LCD: 'LCD bloqs',
                LANG_LCD_DEF: 'LCD (2x16)',
                LANG_LCD_PINS: 'LCD Pins',
                ...
                //ENTRADAS blocks :
                LANG_CATEGORY_ENTRADAS: 'ENTRADAS bloqs',
                LANG_ENTRADAS_BUTTON: 'Botão',
                LANG_ENTRADAS_BUTTON_PIN: 'PIN#',
                LANG_ENTRADAS_BUTTON_TOOLTIP: 'Botão ENTRADAS',
                LANG_ENTRADAS_FOLLOWER: 'Sensor infravermelho',
                LANG_ENTRADAS_FOLLOWER_PIN_LEFT: 'PINO ESQUERDA#',
                LANG_ENTRADAS_FOLLOWER_PIN_RIGHT: 'PINO DIREITA#',
                LANG_ENTRADAS_FOLLOWER_LEFT: 'Esquerda',
                LANG_ENTRADAS_FOLLOWER_RIGHT: 'Direita',
                LANG_ENTRADAS_FOLLOWER_TOOLTIP: 'Devolve o valor digital do sensor infravermelho ENTRADAS',
                LANG_ENTRADAS_INFRARED: 'Sensor infravermelho',
                LANG_ENTRADAS_INFRARED_PIN: 'PIN#',
                LANG_ENTRADAS_INFRARED_TOOLTIP: 'Devolve o valor digital do sensor infravermelho ENTRADAS',
                LANG_SALIDAS_LED: 'LED',
                LANG_SALIDAS_LED_PIN: 'PIN#',
                LANG_SALIDAS_LED_ON: 'ACENDER',
                LANG_SALIDAS_LED_OFF: 'APAGAR',
                ...
                LANG_ENTRADAS_PHOTORESISTOR: 'Sensor de Luz',
                LANG_ENTRADAS_PHOTORESISTOR_PIN: 'PIN#',
                LANG_ENTRADAS_PHOTORESISTOR_TOOLTIP: 'Devolve o valor analógico do sensor de luz (foto-resistência).',
                LANG_SALIDAS_PIEZO_BUZZER: 'Cigarra',
                LANG_SALIDAS_PIEZO_BUZZER_PIN: 'PIN#',
                LANG_SALIDAS_PIEZO_BUZZER_TONE: 'TOM',
                LANG_SALIDAS_PIEZO_BUZZER_DO: 'DO',
                ...
                LANG_SALIDAS_PIEZO_BUZZER_SI: 'SI',
                LANG_SALIDAS_PIEZO_BUZZER_DURATION: 'Duração',
                LANG_SALIDAS_PIEZO_BUZZER_TOOLTIP: 'Cigarra',
                LANG_SALIDAS_PIEZO_BUZZERAV: 'Cigarra avançado',
                LANG_SALIDAS_PIEZO_BUZZERAV_PIN: 'PIN#',
                LANG_SALIDAS_PIEZO_BUZZERAV_TONE: 'TOM',
                LANG_SALIDAS_PIEZO_BUZZERAV_DURATION: 'Duração',
                LANG_SALIDAS_PIEZO_BUZZERAV_TOOLTIP: 'Cigarra - Elemento piezoelétrico avançado.',
                LANG_ENTRADAS_POTENTIOMETER: 'Potenciômetro',
                LANG_ENTRADAS_POTENTIOMETER_PIN: 'PIN#',
                LANG_ENTRADAS_POTENTIOMETER_TOOLTIP: 'Potenciômetro ENTRADAS.',
                //servo blocks :
                LANG_CATEGORY_SERVO: 'Servo',
        ...
        (function() {
            var language = {
                ...
                LANG_SALIDAS_PIEZO_BUZZERAV_DURATION: 'Duração',
                LANG_SALIDAS_PIEZO_BUZZERAV_TOOLTIP: 'Cigarra avançado',
                LANG_SALIDAS_POTENTIOMETER: 'Potenciómetro',
                LANG_SALIDAS_POTENTIOMETER_PIN: 'PIN#',
                LANG_SALIDAS_POTENTIOMETER_TOOLTIP: 'Devolve o valor analógico medido pelo potenciómetro',
                //LCD blocks:
                LANG_CATEGORY_LCD: 'LCD bloqs',
                LANG_LCD_DEF: 'LCD (2x16)',
                LANG_LCD_PINS: 'LCD Pins',
                ...
                LANG_ENTRADAS_BUTTON_PIN: 'PIN#',
                LANG_ENTRADAS_BUTTON_TOOLTIP: 'Botão ENTRADAS',
                LANG_ENTRADAS_FOLLOWER: 'Sensor infravermelhos',
                LANG_ENTRADAS_FOLLOWER_PIN_LEFT: 'PINO ESQUERDA#',
                LANG_ENTRADAS_FOLLOWER_PIN_RIGHT: 'PINO DIREITA#',
                LANG_ENTRADAS_FOLLOWER_LEFT: 'Esquerda',
                LANG_ENTRADAS_FOLLOWER_RIGHT: 'Direita',
                LANG_ENTRADAS_FOLLOWER_TOOLTIP: 'Devolve o valor digital do sensor infravermelhos ENTRADAS',
                LANG_ENTRADAS_INFRARED: 'Sensor infravermelhos',
                LANG_ENTRADAS_INFRARED_PIN: 'PIN#',
                LANG_ENTRADAS_INFRARED_TOOLTIP: 'Devolve o valor digital do sensor infravermelhos ENTRADAS',
                LANG_SALIDAS_LED: 'LED',
                LANG_SALIDAS_LED_PIN: 'PIN#',
                LANG_SALIDAS_LED_ON: 'ACENDER',
                LANG_SALIDAS_LED_OFF: 'APAGAR',
                ...
                LANG_SALIDAS_PIEZO_BUZZERAV_TONE: 'TOM',
                LANG_SALIDAS_PIEZO_BUZZERAV_DURATION: 'Duração',
                LANG_SALIDAS_PIEZO_BUZZERAV_TOOLTIP: 'Cigarra - Elemento piezoeléctrico avançado.',
                LANG_ENTRADAS_POTENTIOMETER: 'Potenciómetro',
                LANG_ENTRADAS_POTENTIOMETER_PIN: 'PIN#',
                LANG_ENTRADAS_POTENTIOMETER_TOOLTIP: 'Potenciómetro ENTRADAS.',
                //servo blocks :
                LANG_CATEGORY_SERVO: 'Servo',
                LANG_SERVO_CONT: 'Servo de rotação contínua',
                LANG_SERVO_CONT_PIN: 'PIN#',
        ...
        (function() {
            var language = {
                ...
                LANG_SALIDAS_BLUETOOTH_RECEIVE: 'Bluetooth: приемник ',
                LANG_SALIDAS_BLUETOOTH_RECEIVE_BLUETOOTH: 'Bluetooth',
                LANG_SALIDAS_BLUETOOTH_RECEIVE_TOOLTIP: 'Возвращает данные, полученные с помощью модуля Bluetooth',
                LANG_SALIDAS_BLUETOOTH_SEND: 'Bluetooth: Отправить',
                LANG_SALIDAS_BLUETOOTH_SEND_SEND: 'Передать данные',
                LANG_SALIDAS_BLUETOOTH_SEND_TOOLTIP: 'Входные данные передаются с помощью модуля Bluetooth',
                LANG_SALIDAS_BLUETOOTH_DEF: 'Bluetooth',
                LANG_SALIDAS_BLUETOOTH_DEF_BAUD_RATE: 'Скорость передачи',
                LANG_SALIDAS_BLUETOOTH_DEF_PIN1: 'RX',
                LANG_SALIDAS_BLUETOOTH_DEF_PIN2: 'TX',
                LANG_SALIDAS_BLUETOOTH_DEF_NAME: 'Имя',
                LANG_SALIDAS_BLUETOOTH_DEF_PINCODE: 'Кодовый PIN',
                LANG_SALIDAS_BLUETOOTH_DEF_RECEIVE: 'Прием',
                LANG_SALIDAS_BLUETOOTH_DEF_SEND: 'Передача',
                LANG_SALIDAS_BLUETOOTH_DEF_TOOLTIP: 'Определяет подключение к модулю Bluetooth',
                ...
                         // SALIDAS блоки:
                        LANG_CATEGORY_SALIDAS: 'Блоки Octopus',
                        LANG_ENTRADAS_ULTRASONIDO: 'BAT - ультразвуковой датчик',
                        LANG_ENTRADAS_ULTRASONIDO_RED_PIN: 'ECHO PIN #',
                        LANG_ENTRADAS_ULTRASONIDO_BLUE_PIN: 'TRIGGER PIN #',
                        LANG_ENTRADAS_ULTRASONIDO_TOOLTIP: 'Возвращает расстояние, измеренное датчиком.',
                        LANG_SALIDAS_BUTTON: 'Кнопка',
                        LANG_SALIDAS_BUTTON_PIN: 'PIN# ',
                        LANG_SALIDAS_BUTTON_TOOLTIP: 'Кнопка',
                        LANG_SALIDAS_BUTTONS: 'Кнопка',
                        LANG_SALIDAS_BUTTONS_PIN: 'PIN# ',
                        LANG_SALIDAS_BUTTONS_BUTTON_A: '#A Кнопка',
                        LANG_SALIDAS_BUTTONS_BUTTON_B: '#B Кнопка',
                        LANG_SALIDAS_BUTTONS_BUTTON_C: '#C Кнопка',
                        LANG_SALIDAS_BUTTONS_BUTTON_D: '#D Кнопка',
                        LANG_SALIDAS_BUTTONS_BUTTON_E: '#E Кнопка',
                        LANG_SALIDAS_BUTTONS_TOOLTIP: 'Кнопка на базе аналогового порта',
                        LANG_ENTRADAS_PIR: 'Инфракрасный датчик',
                        LANG_ENTRADAS_PIR_PIN: 'PIN# ',
                        LANG_ENTRADAS_PIR_TOOLTIP: 'Возвращает цифровое значение, измеренное ИК-датчиком ',
                        LANG_SALIDAS_JOYSTICK: 'Джойстик',
                        LANG_SALIDAS_JOYSTICK_PIN_X: 'X ось PIN# ',
                        LANG_SALIDAS_JOYSTICK_PIN_Y: 'У ось PIN# ',
                        LANG_SALIDAS_JOYSTICK_POSITION: 'Позиция джойстика',
                        LANG_SALIDAS_JOYSTICK_PIN_BUTTON: 'PIN# кнопки',
                        LANG_SALIDAS_JOYSTICK_TOOLTIP: 'Джойстик',
                        LANG_SALIDAS_LED: 'LED',
                        LANG_SALIDAS_LED_PIN: 'PIN# ',
                        LANG_SALIDAS_LED_STATE: '',
                        LANG_SALIDAS_LED_ON: 'Включить',
                        LANG_SALIDAS_LED_OFF: 'Выключить',
                        LANG_SALIDAS_LED_TOOLTIP: 'Светодиод',
                        LANG_SALIDAS_PHOTORESISTOR: 'Датчик света',
                        LANG_SALIDAS_PHOTORESISTOR_PIN: 'PIN# ',
                        LANG_SALIDAS_PHOTORESISTOR_TOOLTIP: 'Возвращает аналоговое значение, измеренное на фоторезисторе.',
                        LANG_SALIDAS_PIEZO_BUZZER: 'Звукоизлучатель',
                        LANG_SALIDAS_PIEZO_BUZZER_PIN: 'PIN # ',
                        LANG_SALIDAS_PIEZO_BUZZER_TONE: 'Тон',
                        LANG_SALIDAS_PIEZO_BUZZER_DO: 'ДО',
                        LANG_SALIDAS_PIEZO_BUZZER_RE: 'РЕ',
                        LANG_SALIDAS_PIEZO_BUZZER_MI: 'МИ',
                        LANG_SALIDAS_PIEZO_BUZZER_FA: 'ФА',
                        LANG_SALIDAS_PIEZO_BUZZER_SOL: 'СОЛЬ',
                        LANG_SALIDAS_PIEZO_BUZZER_LA: 'ЛЯ',
                        LANG_SALIDAS_PIEZO_BUZZER_SI: 'СИ',
                        LANG_SALIDAS_PIEZO_BUZZER_DURATION: 'Продолжительность',
                        LANG_SALIDAS_PIEZO_BUZZER_TOOLTIP: 'Звукоизлучатель - пьезоэлектрический элемент. Излучает звук фиксированной тональности.',
                        LANG_SALIDAS_PIEZO_BUZZERAV: 'Расширенный звукоизлучатель',
                        LANG_SALIDAS_PIEZO_BUZZERAV_PIN: 'PIN# ',
                        LANG_SALIDAS_PIEZO_BUZZERAV_TONE: 'Тон',
                        LANG_SALIDAS_PIEZO_BUZZERAV_DURATION: 'Продолжительность',
                        LANG_SALIDAS_PIEZO_BUZZERAV_TOOLTIP: 'Звукоизлучатель - пьезоэлектрический элемент. Излучает звук заданной тональности.',
                        LANG_SALIDAS_POTENTIOMETER: 'Потенциометр',
                        LANG_SALIDAS_POTENTIOMETER_PIN: 'PIN# ',
                        LANG_SALIDAS_POTENTIOMETER_TOOLTIP: 'Возвращает аналоговое значение, измеренное с помощью потенциометра ',
                         // ЖК блоки:
                ...
                LANG_VARIABLES_TYPE_STRING: 'String', // To translate
                         // ENTRADAS блоки:
                        LANG_CATEGORY_ENTRADAS: 'Блоки ENTRADAS',
                        LANG_ENTRADAS_BUTTON: 'Кнопка',
                        LANG_ENTRADAS_BUTTON_PIN: 'PIN# ',
                        LANG_ENTRADAS_BUTTON_TOOLTIP: 'Кнопка ENTRADAS ',
                        LANG_ENTRADAS_FOLLOWER: 'инфракрасный датчик',
                        LANG_ENTRADAS_FOLLOWER_PIN_LEFT: 'левый PIN # ',
                        LANG_ENTRADAS_FOLLOWER_PIN_RIGHT: 'правый PIN #',
                        LANG_ENTRADAS_FOLLOWER_LEFT: 'Cлева',
                        LANG_ENTRADAS_FOLLOWER_RIGHT: 'Справа',
                        LANG_ENTRADAS_FOLLOWER_TOOLTIP: 'Возвращает значение цифрового инфракрасного датчика ',
                        LANG_ENTRADAS_INFRARED: 'инфракрасный датчик',
                        LANG_ENTRADAS_INFRARED_PIN: 'PIN# ',
                        LANG_ENTRADAS_INFRARED_TOOLTIP: 'Возвращает значение цифрового инфракрасного датчика ',
                        LANG_SALIDAS_LED: 'LED',
                        LANG_SALIDAS_LED_PIN: 'PIN# ',
                        LANG_SALIDAS_LED_ON: 'ВКЛ',
                        LANG_SALIDAS_LED_OFF: 'ВЫКЛ',
                        LANG_SALIDAS_LED_TOOLTIP: 'светодиодные излучатели ENTRADAS ',
                        LANG_ENTRADAS_PHOTORESISTOR: 'Датчик света',
                        LANG_ENTRADAS_PHOTORESISTOR_PIN: 'PIN# ',
                        LANG_ENTRADAS_PHOTORESISTOR_TOOLTIP: 'Возвращает аналоговое значение датчика света (фоторезистора).',
                        LANG_SALIDAS_PIEZO_BUZZER: 'Звукоизлучатель',
                        LANG_SALIDAS_PIEZO_BUZZER_PIN: 'PIN# ',
                        LANG_SALIDAS_PIEZO_BUZZER_TONE: 'Тон',
                        LANG_SALIDAS_PIEZO_BUZZER_DO: 'ДО',
                ...
                        LANG_SALIDAS_PIEZO_BUZZER_SI: 'СИ',
                        LANG_SALIDAS_PIEZO_BUZZER_DURATION: 'Продолжительность',
                        LANG_SALIDAS_PIEZO_BUZZER_TOOLTIP: 'Звукоизлучатель пьезоэлектрический.',
                        LANG_SALIDAS_PIEZO_BUZZERAV: 'Расширенный звукоизлучатель',
                        LANG_SALIDAS_PIEZO_BUZZERAV_PIN: 'PIN # ',
                        LANG_SALIDAS_PIEZO_BUZZERAV_TONE: 'Тон',
                        LANG_SALIDAS_PIEZO_BUZZERAV_DURATION: 'Продолжительность',
                        LANG_SALIDAS_PIEZO_BUZZERAV_TOOLTIP: 'Звукоизлучатель - пьезоэлектрический элемент.',
                        LANG_ENTRADAS_POTENTIOMETER: 'Потенциометр',
                        LANG_ENTRADAS_POTENTIOMETER_PIN: 'PIN# ',
                        LANG_ENTRADAS_POTENTIOMETER_TOOLTIP: 'потенциометр ENTRADAS.',
                         // Серво блоки:
        ...
        RoboBlocks.LANG_COLOUR_PROCEDURES = '#607D8B';
