    ...
    var load = function(options) {
        ...
        (function() {
            var language = {
                ...
                LANG_ADELANTE: 'ADELANTE',
                LANG_ADELANTE_PIN: 'PIN#',
                LANG_ADELANTE_ON: 'ENCENDRE',
                LANG_ADELANTE_OFF: 'APAGAR',
                LANG_ADELANTE_TOOLTIP: 'LED zum',
            ...
            if (typeof window !== 'undefined' && Roboblocks2 && Roboblocks2.locales.add) {
                Roboblocks2.locales.add('ca-ES', language);
            }
        }());
        ...
        (function() {
            var language = {
                ...
                //zum blocks :
                LANG_CATEGORY_ZUM: 'Bloqs',
                LANG_ZUM_BUTTON: 'Button',
                LANG_ZUM_BUTTON_PIN: 'PIN#',
                LANG_ZUM_BUTTON_TOOLTIP: 'Button',
                ...
                LANG_ADELANTE_PIN: 'PIN#',
                LANG_ADELANTE_ON: 'ON',
                LANG_ADELANTE_OFF: 'OFF',
                LANG_ADELANTE_TOOLTIP: 'LED',
            ...
            // Browser
            // if (typeof window !== 'undefined' && this.Roboblocks2 && this.Roboblocks2.locales.add) {
            //     this.Roboblocks2.locales.add('en', language);
            if (typeof window !== 'undefined' && Roboblocks2 && Roboblocks2.locales.add) {
                Roboblocks2.locales.add('en-GB', language);
            }
        }());
        ...
        (function() {
            var language = {
                ...
                //zum blocks :
                LANG_CATEGORY_EDUCABOT: 'DINOBOT',
        ...
        (function() {
            var language = {
                ...
                LANG_ADELANTE: 'LED',
                LANG_ADELANTE_PIN: 'PIN#',
                LANG_ADELANTE_ON: 'PIZTU',
                LANG_ADELANTE_OFF: 'ITZALI',
                LANG_ADELANTE_TOOLTIP: 'zum LED',
            ...
            //     this.Roboblocks2.locales.add('es', language);
            if (typeof window !== 'undefined' && Roboblocks2 && Roboblocks2.locales.add) {
                Roboblocks2.locales.add('eu-ES', language);
            }
        }());
        ...
        (function() {
            ...
            //     this.Roboblocks2.locales.add('en', language);
            if (typeof window !== 'undefined' && Roboblocks2 && Roboblocks2.locales.add) {
                Roboblocks2.locales.add('fr-FR', language);
            }
        }());
        ...
        (function() {
            var language = {
                ...
                LANG_ADELANTE: 'LED',
                LANG_ADELANTE_PIN: 'PIN#',
                LANG_ADELANTE_ON: 'ACCESO',
                LANG_ADELANTE_OFF: 'SPENTO',
                LANG_ADELANTE_TOOLTIP: 'LED ZUM',
            ...
            //     this.Roboblocks2.locales.add('en', language);
            if (typeof window !== 'undefined' && Roboblocks2 && Roboblocks2.locales.add) {
                Roboblocks2.locales.add('it-IT', language);
            }
        }());
        ...
        (function() {
            var language = {
                ...
                LANG_ADELANTE: 'Dioda LED',
                LANG_ADELANTE_PIN: 'PIN#',
                LANG_ADELANTE_ON: 'właczona',
                LANG_ADELANTE_OFF: 'wyłączona',
                LANG_ADELANTE_TOOLTIP: 'Dioda LED Zum',
            ...
            //     this.Roboblocks2.locales.add('es', language);
            if (typeof window !== 'undefined' && Roboblocks2 && Roboblocks2.locales.add) {
                Roboblocks2.locales.add('pl-PL', language);
            }
        }());
        ...
        (function() {
            ...
            //     this.Roboblocks2.locales.add('es', language);
            if (typeof window !== 'undefined' && Roboblocks2 && Roboblocks2.locales.add) {
                Roboblocks2.locales.add('pt-BR', language);
            }
        }());
        ...
        (function() {
            ...
            //     this.Roboblocks2.locales.add('es', language);
            if (typeof window !== 'undefined' && Roboblocks2 && Roboblocks2.locales.add) {
                Roboblocks2.locales.add('pt-PT', language);
            }
        }());
        ...
        (function() {
            var language = {
                ...
                        LANG_ADELANTE: 'LED',
                        LANG_ADELANTE_PIN: 'PIN# ',
                        LANG_ADELANTE_ON: 'ВКЛ',
                        LANG_ADELANTE_OFF: 'ВЫКЛ',
                        LANG_ADELANTE_TOOLTIP: 'светодиодные излучатели Zum ',
            ...
            //     this.Roboblocks2.locales.add('es', language);
            if (typeof window !== 'undefined' && Roboblocks2 && Roboblocks2.locales.add) {
                Roboblocks2.locales.add('ru', language);
            }
        }());
        ...
        // help URLs
        Roboblocks2.GITHUB_SRC_URL = 'https://github.com/bq/Roboblocks2/tree/master/src/';
        Roboblocks2.URL_LED = 'http://diwo.bq.com/programando-un-led-en-bitbloq-i/';
        Roboblocks2.URL_LDR = 'http://diwo.bq.com/el-sensor-de-luz/';
        Roboblocks2.URL_BUTTON = 'http://diwo.bq.com/programando-el-pulsador-en-bitbloq/';
        Roboblocks2.URL_BUZZER = 'http://diwo.bq.com/programando-el-zumbador-en-bitbloq/';
        Roboblocks2.URL_POTENTIOMETER = 'http://diwo.bq.com/programando-un-potenciometro-en-bitbloq/';
        Roboblocks2.URL_IR = 'http://diwo.bq.com/programando-un-sensor-infrarrojo-en-bitbloq/';
        Roboblocks2.URL_CONTINUOUS_ROTATION_SERVO = 'http://diwo.bq.com/programando-un-servo-en-bitbloq/';
        Roboblocks2.URL_SERVO = 'http://diwo.bq.com/programando-un-miniservo-en-bitbloq/';
        Roboblocks2.URL_LCD = 'http://diwo.bq.com/programando-una-pantalla-lcd-en-bitbloq/';
        Roboblocks2.URL_US = 'http://diwo.bq.com/programando-el-sensor-ultrasonido-en-bitbloq/';
        Roboblocks2.URL_BUTTONS = 'http://diwo.bq.com/programando-la-botonera-en-bitbloq/';
        Roboblocks2.URL_JOYSTICK = 'http://diwo.bq.com/programando-un-joystick-con-bitbloq/';
        Roboblocks2.URL_SERIE = 'http://diwo.bq.com/comunicacion-puerto-serie-en-windows-7/';
        Roboblocks2.URL_IF = 'http://diwo.bq.com/programando-los-bloques-de-control-el-bloque-si-ejecutar/';
        Roboblocks2.URL_SWITCH = 'http://diwo.bq.com/programando-los-bloques-de-control-el-bloque-si-switch-case/';
        Roboblocks2.URL_WHILE = 'http://diwo.bq.com/programando-los-bloques-de-control-el-bloque-mientras/';
        Roboblocks2.URL_FOR = 'http://diwo.bq.com/programando-los-bloques-de-control-el-bloque-contar/';
        Roboblocks2.URL_FLOW_STATEMENTS = 'http://diwo.bq.com/programando-los-bloques-de-control-interrumpir/';
        Roboblocks2.URL_LOGIC = 'http://diwo.bq.com/programando-los-bloques-logicos/';
        Roboblocks2.URL_MATH = 'http://diwo.bq.com/programando-los-bloques-matematicos/';
        Roboblocks2.URL_TEXT = 'http://diwo.bq.com/programando-los-bloques-de-texto/';
        Roboblocks2.URL_BT = 'http://diwo.bq.com/ejemplo-en-bitbloq-de-comunicacion-bluetooth/';
        Roboblocks2.URL_VAR = 'http://diwo.bq.com/programando-con-variables-en-bitbloq/';
        Roboblocks2.URL_PROC_NO_RET = 'http://diwo.bq.com/programando-con-funciones-en-bitbloq/';
        Roboblocks2.URL_PROC = 'http://diwo.bq.com/programando-con-funciones-en-bitbloq-2/';
        Roboblocks2.URL_PIN_FUNC = 'http://diwo.bq.com/programando-los-bloques-funciones-pin';
...
;
        ...
        Blockly.Blocks.ADELANTE = {
            category: Roboblocks2.locales.getKey('LANG_CATEGORY_EDUCABOT'),
            tags: ['led'],
            helpUrl: Roboblocks2.URL_LED,
            /**
